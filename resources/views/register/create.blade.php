                            ...
                            <div
                                ...
                                <div class="card card-plain">
                                    <div class="card-header">
                                        ...
                                        <p class="mb-0">Ingresa tu nombre, correo electrónico y contraseña para registrarte</p>
                                    </div>
                                    <div class="card-body">
                                        <form method="POST" action="{{ route('register') }}">
                                            ...
                                            <div class="form-check form-check-info text-start ps-0 mt-3">
                                                <input class="form-check-input bg-info" type="checkbox" value=""
                                            ...
                                            <div class="text-center">
                                                <button type="submit"
                                                    class="btn btn-lg bg-info text-white btn-lg w-100 mt-4 mb-0">Sign
                                                    Up</button>
                                            </div>
                                        </form>
                                    </div>
