                            ...
                            <form action="{{ route('actividad.update', $actividad->id_actividad) }}" method="POST">
                                    ...
                                    <select name="id_empresa"
                                        ...
                                        @foreach ($empresas as $empresa)
                                            <option value="{{ $empresa->id_empresa }}"
                                                {{ old('id_empresa', $actividad->id_empresa) == $empresa->id_empresa ? 'selected' : '' }}>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="date" name="fecha_finalizacion"
                                        ...
                                        value="{{ old('fecha_finalizacion', $actividad->fecha_finalizacion) }}"
                                        required>
                                    ...
                                    <select name="id_estado"
                                        ...
                                        @foreach ($estados as $estado)
                                            <option value="{{ $estado->id_estado }}"
                                                {{ old('id_estado', $actividad->id_estado) == $estado->id_estado ? 'selected' : '' }}>
