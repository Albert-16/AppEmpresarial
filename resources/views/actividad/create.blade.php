                            ...
                            <form action="{{ route('actividad.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="nombre_actividad"
                                        class="form-control bg-light p-2 @error('nombre_actividad') is-invalid @enderror"
                                        value="{{ old('nombre_actividad') }}" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="id_empresa"
                                        class="form-control p-2 bg-light @error('id_empresa') is-invalid @enderror">
                                ...
                                <div class="form-group  mt-2">
                                    ...
                                    <input type="date" name="fecha_inicio"
                                        class="form-control p-2 bg-light @error('fecha_inicio') is-invalid @enderror"
                                ...
                                <div class="form-group  mt-2">
                                    ...
                                    <input type="date" name="fecha_finalizacion"
                                        class="form-control p-2 bg-light @error('fecha_finalizacion') is-invalid @enderror"
                                        value="{{ old('fecha_finalizacion') }}" required>
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="number" name="costo"
                                        class="form-control p-2 bg-light @error('costo') is-invalid @enderror"
                                ...
                                <div class="form-group mt-2">
                                    ...
                                    <input type="number" name="egresos"
                                        class="form-control p-2 bg-light @error('egresos') is-invalid @enderror"
                                        value="{{ old('egresos') }}" required>
                                    @error('egresos')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group  mt-2">
                                    ...
                                    <select name="id_estado"
                                        class="form-control bg-light p-2 @error('id_estado') is-invalid @enderror"
                                        required>
                                ...
                                <div class="form-group d-flex justify-content-end mt-3">
                                    <div class="mr-3">
                                        ...
                                        <a href="{{ route('actividad.index') }}" role="button"
