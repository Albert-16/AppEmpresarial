            ...
            <div class="card card-body mx-3 mx-md-4 mt-n6">
                <div class="row gx-4 mb-2">
                    <div class="col-auto">
                        <div class="avatar avatar-xl position-relative">
                            <img src="{{ asset('assets') }}/img/user.png" alt="profile_image"
                ...
                <div class="card card-plain h-100">
                    ...
                    <div class="card-body p-3">
                        @if (session('success'))
                        <div id="alert" class="alert alert-success text-center text-white col-sm" role="alert">
                            {{ session('success') }}
                        </div>
                    @endif
                        @if (Session::has('demo'))
                            ...
                            <div class="row">
                                ...
                                <div class="mb-3 col-md-12">
                                    ...
                                    <textarea class="form-control border border-2 p-2"
                                        placeholder="Escribe algo acerca de ti..." id="floatingTextarea2" name="about"
